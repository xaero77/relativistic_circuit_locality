...
- generalized wavepacket wrapper, microcausality commutator surrogate, full-QFT surrogate bundle, reference PDE control bundle, universal state family bundle, exact mediator surrogate bundle
...
- wavepacket/generalized packet: `compute_wavepacket_phase_matrix`, `analyze_wavepacket_phase_decomposition`, `GeneralizedWavepacketResult`, `compute_generalized_wavepacket_phase_matrix`
